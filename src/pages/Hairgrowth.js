...
export default function LAscorbicLipBalm() {
  ...
  return (
    <>
      <Head>
        <title>L-Ascorbic Acid 8% Lip Treatment Balm</title>
        <meta charSet="UTF-8" />
...
<br></br><br></br><br></br>
      ...
      <div className="product-wrapper">
        <div className="left-col">
          <img src="/images\hargwth18-2.avif" id="productImg" className="main-image" alt="Lip Balm" />
          <div className="thumbnail-row">
            {[1, 2, 3, 4].map((_, i) => (
              <img key={i} src="/images\hargwth18-2.avif" className="small-img" alt={`thumb-${i}`} />
            ))}
          </div>
        </div>

        <div className="right-col">
          <h1>Hair Growth Actives 18% Hair Serum</h1>
