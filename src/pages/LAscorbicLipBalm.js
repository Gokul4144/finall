    ...
    <>
      ...
      <div className="product-wrapper">
        <div className="left-col">
          <img src="/images/lipbalm-1.avif" id="productImg" className="main-image" alt="Lip Balm" />
          <div className="thumbnail-row">
            {[1, 2, 3, 4].map((_, i) => (
              <img key={i} src="/images/lipbalm-1.avif" className="small-img" alt={`thumb-${i}`} />
            ))}
          </div>
        </div>
        ...
        <div className="right-col">
          ...
          <ul>
            ...
            <li>• L-Ascorbic Acid + Radianskin reduce dark spots and discoloration</li>
